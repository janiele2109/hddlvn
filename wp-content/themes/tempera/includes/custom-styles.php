...
<?php if ($tempera_metapos == 'Top' || $tempera_metapos == 'Hide') { ?> footer.entry-meta { display: none; } <?php } ?>
<?php if ($tempera_metapos == 'Bottom' || $tempera_metapos == 'Hide') { ?> header.entry-header > .entry-meta { display: none; } <?php } ?>
