...
if ( get_theme_mod( 'vogue-social-facebook', false ) ) :
    echo '<a href="' . esc_html( get_theme_mod( 'vogue-social-facebook' ) ) . '?userinfo" title="' . __( 'Contact Us on Facebook', 'vogue' ) . '" class="header-social-icon social-facebook" target="_blank"><i class="fa fa-facebook"></i></a>';
endif;

if ( get_theme_mod( 'vogue-social-google-plus', false ) ) :
    echo '<a href="' . esc_html( get_theme_mod( 'vogue-social-google-plus' ) ) . '?userinfo" title="' . __( 'Contact Us on Google Plus', 'vogue' ) . '" class="header-social-icon social-google-plus" target="_blank"><i class="fa fa-google-plus"></i></a>';
endif;

if ( get_theme_mod( 'vogue-social-linkedin', false ) ) :
    echo '<a href="' . esc_url( get_theme_mod( 'vogue-social-linkedin' ) ) . '" target="_blank" title="' . __( 'Find Us on LinkedIn', 'vogue' ) . '" class="header-social-icon social-linkedin" target="_blank"><i class="fa fa-linkedin"></i></a>';
endif;
