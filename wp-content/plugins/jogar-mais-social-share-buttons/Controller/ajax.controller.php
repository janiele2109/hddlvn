...
class Ajax_Controller
{
	...
	*/
	...
	{
		$cache = get_transient( Setting::TRANSIENT_SHARE_OBJECTS );

		if ( false !== $cache )
			return $cache;

		$objects = Core::social_media_objects();
		set_transient( Setting::TRANSIENT_SHARE_OBJECTS, $objects, WEEK_IN_SECONDS * 1 );
