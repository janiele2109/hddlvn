JOGARMAIS( 'SSB.Components.CounterSocialShare', function(CounterSocialShare, $) {
	...
	CounterSocialShare.prototype.start = function(container) {
		...
		this.closeButtons     = SSB.vars.body.byAction( 'close-buttons' );
		this.totalCounter     = 0;
